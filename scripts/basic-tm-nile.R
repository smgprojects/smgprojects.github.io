#from basic text mining https://rstudio-pubs-static.s3.amazonaws.com/31867_8236987cf0a8444e962ccd2aec46d9c3.html
...
cname <- file.path("/Users", "shawngraham", "nile-diary-analysis")   
cname   
dir(cname)
...
findAssocs(dtm, c("statue" , "I"), corlimit=0.98) # specifying a correlation limit of 0.98   
# 
